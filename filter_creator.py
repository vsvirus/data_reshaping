...
filters = {'gender': ['3', '1'], 'height_cm': [164.6, 190.65], 'Morphin':[10,10], 'Clinico.other_symptoms': ['locura']}
# Lo transformo en :
...
Variables = ['Basic.height_cm', 'Amoxicilina', 'Morphin', 'haematocrit', 'Basic.Condiciones_Previas']
